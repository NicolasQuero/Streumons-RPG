...
Entity::Entity(char type, int x, int y, int hp, int dmg) : type(type), hp(hp), dmg(dmg), is_alive(true), pos(x, y) {}

Entity::Entity(char type, Pos p, int hp, int dmg) : type(type), hp(hp), dmg(dmg), is_alive(true), pos(p) {}
